...
public class DList2 {
  ...
  /**
   *  displayCount() displays the number of nodes in the list
   */
  ...
  /**
   *  find() calls the functions findMin() and findMax()
   */
  public void find(){
  	findMin();
  	findMax();
  ...
  /**
   *  findMin() displays the minimum item in the list
   */
  public void findMin(){

    if(size==0)
      System.out.println("Minimum: Empty List");
    
    else
    {
      DListNode2 temp = new DListNode2();
      int min = head.next.item;
      int ctr = 0;
  ...
  /**
   *  findMax() displays the maximum item in the list
   */
  public void findMax(){

    if(size==0)
      System.out.println("Maximum: Empty List");
