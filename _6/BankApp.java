...
public class BankApp {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      while (!command.equals("quit")) {
        ...
        catch(BadAccountException er){
          System.err.println(er);
        }

        catch(BadTransactionException err){
  ...
  *  @exception IOException if there are problems reading user input.
  */
  private void doDeposit() throws IOException , BadTransactionException, BadAccountException{
    // Get account number.
  ...
  private int readInt(String prompt) throws IOException {
    ...
    //System.out.println("STRING " + prompt + " is " + text);
